...
import com.manueh.winxclubreborn.common.models.PowerBallModel;
...
public class PowerBallThrownRenderer extends EntityRenderer<PowerBallThrown> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID, "textures/entity/power_ball.png");
    private PowerBallModel model;

    public PowerBallThrownRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new PowerBallModel(context.bakeLayer(ClientRenderer.POWER_BALL_LAYER));
    }

    public void render(PowerBallThrown p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(PowerBallThrown p_114482_) {
        return TEXTURE;
    }
}
