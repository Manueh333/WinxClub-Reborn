...
public class HitOfNatureRenderer extends EntityRenderer<HitOfNatureThrown>
{

public static final ResourceLocation TEXTURE = new ResourceLocation(Main.MODID, "textures/entity/hit_of_nature.png");
private HitOfNatureModel model;

public HitOfNatureRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.model = new HitOfNatureModel(context.bakeLayer(ClientRenderer.HIT_OF_NATURE_LAYER));
        }

public void render(HitOfNatureThrown p_116111_, float p_116112_, float p_116113_, PoseStack p_116114_, MultiBufferSource p_116115_, int p_116116_) {
        p_116114_.pushPose();
...
@Override
public ResourceLocation getTextureLocation(HitOfNatureThrown p_114482_) {
        return TEXTURE;
        }
        }
