...
import com.manueh.winxclubreborn.common.storages.MagicPowderStorage;
        ...
        addDataSlot(new DataSlot() {
            ...
            public void set(int value) {
                blockEntity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((MagicPowderStorage)h).setEnergy(energyStored + (value & 0xffff));
                });
            }
        });
        addDataSlot(new DataSlot() {
            ...
            public void set(int value) {
                blockEntity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((MagicPowderStorage)h).setEnergy(energyStored | (value << 16));
                });
            }
        });
    }
