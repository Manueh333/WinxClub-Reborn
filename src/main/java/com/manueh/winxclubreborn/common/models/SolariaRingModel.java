...
public class SolariaRingModel extends Model {
    public static final ResourceLocation TEXTURE = new ResourceLocation("textures/entity/solaria_ring.png");
   private final ModelPart root;

    public SolariaRingModel(ModelPart part) {
